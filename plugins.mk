...
PLUGINS += vimsignature
PLUGIN_URL_$(lastword $(PLUGINS)) := https://github.com/kshenoy/vim-signature.git
...
PLUGINS += monokai
PLUGIN_URL_$(lastword $(PLUGINS)) := https://github.com/crusoexia/vim-monokai.git
# colorshames end
